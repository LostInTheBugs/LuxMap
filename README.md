...
**Version:** [2026.08.027](https://github.com/LostInTheBugs/LuxMap/releases)
...
| Natural balance (per commune, 1987–2025) | STATEC LUSTAT (DF_X024, SDMX-JSON) | ✅ integrated |
| Net migration (per commune, 1990–2025) | STATEC LUSTAT (DF_X025, SDMX-JSON) | ✅ integrated |
